...
class GDriveClient extends ChangeNotifier {
  static const folderName = "myfinplan";
  ...
  Future<void> upload() async {
    ...
    //   try {
    //     await driveApi!.files.update(gDriveFile, existingFile.id!, uploadMedia: Media(localFile.openRead(), localFile.lengthSync()));
    //   } catch (err) {
    //     _setStatus(GDriveStatus.failed);
  ...
  Future<void> download() async {
    ...
    // try {
    //   downloadedFile = await driveApi!.files.get(existingFile.id!, downloadOptions: DownloadOptions.fullMedia) as Media;
    // } catch (err) {
    //   _setStatus(GDriveStatus.failed);
    //   debugPrint('G-Drive Error : $err');
    // }
